...
01/11: [Logistic Regression](#class-12-logistic-regression) | 01/13: [Advanced Model Evaluation](#class-13-advanced-model-evaluation)
...
* Complete the [command line homework assignment](homework/02_command_line_chipotle.md) with the Chipotle data. Submit your think through this [form] (http://goo.gl/forms/EamVci00DO)
